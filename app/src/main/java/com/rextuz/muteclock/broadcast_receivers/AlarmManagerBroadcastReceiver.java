...
public class AlarmManagerBroadcastReceiver extends BroadcastReceiver {
    ...
    public void setAlarm(Context context, int requestCode, long muteTime, long unmuteTime, boolean vibrate, String days) {
        AlarmManager am;
        Intent intent;
        ...
        if (days.equals("-------"))
            ...
            am.setRepeating(AlarmManager.RTC_WAKEUP, muteTime, AlarmManager.INTERVAL_DAY, pi1);
        ...
        if (days.equals("-------"))
            ...
            am.setRepeating(AlarmManager.RTC_WAKEUP, unmuteTime, AlarmManager.INTERVAL_DAY, pi2);
    }
